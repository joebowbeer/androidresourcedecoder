...
public class MainTest {
  ...
  /**
   * Test that manifest is unchanged if given -X pattern is specified but matching element is
  ...
  /**
   * Test that manifest is changed if given -X pattern are specified and matching element is present
   * in AndroidManifest.xml, and not changed again after the element is removed.
   */
